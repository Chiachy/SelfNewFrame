...
/**
 * Author by nyw, Email 992116519@qq.com, Date on 2018/12/26.
    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = BaseApp.getApplication().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = BaseApp.getApplication().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
